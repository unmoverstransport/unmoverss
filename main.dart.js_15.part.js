...
D.MH.prototype={
A(d,e){var x,w,v,u,t,s,r,q,p=this,o=null,n=A.e0(5),m=C.a0("Description")
m.Q=B.t
m.ch=E.M
m=m.u()
x=C.a0("Total")
...
x.ch=E.M
w=y.p
x=A.b([new A.ae(E.b0,m,o),B.D,new A.ae(E.b0,x.u(),o)],w)
m=C.a0("Base Fee")
m.Q=B.w
m.ch=E.M
m=m.u()
...
t.Q=B.w
t.ch=E.M
t=A.b([new A.ae(E.b0,m,o),G.oj,new A.ae(E.b0,t.u(),o)],w)
m=C.a0("Discounts")
m.ch=E.M
m.Q=B.t
m=A.b([new A.ae(E.b0,m.u(),o),B.D,B.D],w)
s=C.a0("Mid Month")
s.Q=B.w
s.ch=E.M
s=s.u()
...
r.Q=B.w
r.ch=E.M
r=A.b([new A.ae(E.b0,s,o),G.ok,new A.ae(E.b0,r.u(),o)],w)
s=C.a0("Loyal customer")
s.ch=E.M
s.Q=B.w
s=s.u()
q=C.a0("R "+A.d(v.as))
q.Q=B.w
q.ch=E.M
q=A.b([new A.ae(E.b0,s,o),G.ol,new A.ae(E.b0,q.u(),o)],w)
s=C.a0("Total amount due:")
s.ch=E.M
s.Q=B.Y
s=s.u()
u=C.a0(u)
u.Q=B.Y
u.ch=E.M
w=F.aoi(A.b([new F.dz(new A.bE(B.ft,o,o,n,o,o,B.J),x),new F.dz(o,t),new F.dz(G.e4,m),new F.dz(o,r),new F.dz(G.e4,q),new F.dz(G.e4,A.b([new A.ae(E.b0,s,o),B.D,new A.ae(E.b0,u.u(),o)],w))],y.s),o,G.hC)
n=!v.db
m=C.aot(o,o,!n||p.LX()?B.ba:B.b9,o,o,o,o,o,o,o,o,o,o,B.hA,o,o,o,o)
n=!n||p.LX()?o:new D.a3X(p)
x=C.a0("CANCEL BOOKING")
x.ch=H.YO
...
s=v?o:new D.a3T(p)
w=C.kr(!1,B.a_,o,o,!0,o,o,!1,o,0,o,!1,o,o,u,o,w,C.lE(o,A.wN(H.J1,v?B.ba:B.Z,o),o,s,r,15,o),o)
u=C.cs("Distance: ")
u.d=B.t
u.cx=E.cD
...
u=$.aT
if(u==null)u=$.aT=B.K
v=C.za(new A.ae(E.au,new C.aF(A.b([m,w,s,r,C.be(new D.MH(n,p.gWT(),p.e,x,u.cC(0,o,y.D),o),10,0,0,0)],v),B.q,B.C,o,o),o))
v.c=10
return v.u()},
...
case 1:x=C.bQ(new A.ae(E.R,B.cz,u))
x.r=1/0
x.f=this.b.E(y.w).f.a.b
return x.u()
case 3:return C.a0(d.ch).u()
case 2:x=y.p
if(d.ay.d.length!==0){w=C.a0("Your Bookings".toUpperCase())
w.Q=B.Y
w.ch=H.VR
w=w.u()
...
v.r=500
v.y=B.c1
x=C.bQ(new C.aF(A.b([new A.ae(new A.aj(16,16,16,16),w,u),v.u()],x),B.q,B.C,u,u))
x.r=1/0
x.G6$=B.T
return A.a(x.G5$,"_child").u()}else{x=C.bQ(new A.ae(E.R,new C.aF(A.b([C.a0("Make your first booking!").u()],x),u,u,u,u),u))
x.r=1/0
x.f=this.b.E(y.w).f.a.b
return x.u()}default:return C.a0("there might be an error in your code check your provider").u()}},
$S:516}
D.att.prototype={
...
return{l:x("or"),V:x("mI"),r:x("os"),O:x("k<dP>"),d:x("k<ay>"),s:x("k<dz>"),n:x("k<eL>"),p:x("k<e>"),A:x("aK<kL>"),w:x("dd"),P:x("aw"),D:x("kJ"),N:x("i"),z:x("@"),H:x("~")}})();(function constants(){H.J1=new A.dw(983823,"MaterialIcons",null,!1)
H.VR=new A.x(!0,B.j,null,"Montserrat-SemiBold",null,null,18,B.t,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null)
H.YO=new A.x(!0,B.m,null,null,null,null,14,B.w,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null)})()}
$__dart_deferred_initializers__["dm0uvhRHRKcexIH2E5SP6Qgawv4="] = $__dart_deferred_initializers__.current
