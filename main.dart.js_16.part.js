...
t=A.a1(u)
t.ch=E.K
t=A.b([new A.ab(E.b4,m,o),H.oL,new A.ab(E.b4,t.u(),o)],w)
m=A.a1("Discounts")
m.ch=E.ci
m.Q=B.T
...
r=A.a1("R "+A.d(v.Q))
r.ch=E.K
r=A.b([new A.ab(E.b4,s,o),F.BD,new A.ab(E.b4,r.u(),o)],w)
s=A.a1("Loyal customer")
s.ch=E.K
s=s.u()
q=A.a1("R "+A.d(v.as))
q.ch=E.K
q=A.b([new A.ab(E.b4,s,o),H.oK,new A.ab(E.b4,q.u(),o)],w)
...
u.Q=B.dA
u.ch=E.ci
w=G.aIh(A.b([new G.dJ(new A.bj(B.fG,o,o,n,o,o,B.E),x),new G.dJ(o,t),new G.dJ(H.ek,m),new G.dJ(o,r),new G.dJ(H.ek,q),new G.dJ(H.ek,A.b([new A.ab(E.b4,s,o),B.H,new A.ab(E.b4,u.u(),o)],w))],y.s),H.o1)
n=!v.db
...
$__dart_deferred_initializers__["6TA0WrxefcAJnCVnNBIWiiGsuXo="] = $__dart_deferred_initializers__.current
