...
$__dart_deferred_initializers__.current=function(a,b,c,$){var C={u_:function u_(d){this.a=d},ai1:function ai1(){}},D,B,A,E,G,F
...
x(C.u_,A.a_)
x(C.ai1,A.cZ)})()
A.bI(b.typeUniverse,JSON.parse('{"u_":{"a_":[],"d":[]}}'))
var y={h:A.v("k<i>"),e:A.v("k<d>"),o:A.v("mx"),g:A.v("i")};(function constants(){var x=a.makeConstList
B.rF=A.b(x(["assets/svg/cart.svg","assets/svg/garden.svg","assets/svg/house-office.svg"]),y.h)
