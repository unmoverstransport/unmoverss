...
C.XK.prototype={
af(){A.j4(B.H,null,x.z).b3(0,new C.awH(this),x.P)
this.au()},
B(d,e){var w=null
return new A.fq(A.a([A.eL(new C.awG(e),w,w,w,x.D)],x.p),"/signed-in/bookings",w)}}
C.NZ.prototype={
...
u=A.J("R "+A.d(m))
u.ch=B.a_
u=A.a([new A.a5(B.bC,k,r),E.pu,new A.a5(B.bC,u.n(),r)],v)
k=A.J("Discounts")
k.ch=D.oS
k.Q=B.N
k=A.a([new A.a5(B.bC,k.n(),r),B.A,B.A],v)
t=A.J("Off Peak")
t.ch=B.a_
t=t.n()
o=A.J("R "+A.d(o))
...
n=A.J("R "+A.d(n))
n.ch=B.a_
n=A.a([new A.a5(B.bC,t,r),E.pv,new A.a5(B.bC,n.n(),r)],v)
t=A.J("Total Amount")
t.ch=D.oS
t=t.n()
p=A.J("R "+A.d(p))
p.ch=D.oS
v=A.aLg(A.a([new A.e9(new A.be(r,r,r,l,r,B.k2,B.G),w),new A.e9(r,u),new A.e9(new A.be(r,r,new A.cH(B.r,B.r,new A.bk(B.cc,1.5,B.I),B.r),r,r,r,B.G),k),new A.e9(r,o),new A.e9(new A.be(r,r,new A.cH(B.r,B.r,new A.bk(B.cc,1.5,B.I),B.r),r,r,r,B.G),n),new A.e9(new A.be(r,r,new A.cH(B.r,B.r,new A.bk(B.cc,1.5,B.I),B.r),r,r,r,B.G),A.a([new A.a5(B.bC,t,r),B.A,new A.a5(B.bC,p.n(),r)],v))],x.S),B.oE)
p=A.bo(5)
q=!q.db
p=A.mz(r,r,B.m,r,2,r,r,r,r,r,r,r,B.ay,new A.bK(p,new A.bk(!q||s.D1()?B.ay:B.aH,1.5,B.I)),r,r,r,r)
o=!q||s.D1()?r:new C.a5B(s)
n=A.J("Cancel Booking")
n.ch=A.ay(r,r,!q||s.D1()?B.ay:B.aH,r,r,r,r,r,r,r,r,14,r,B.t,r,r,!0,r,r,r,r,r,r,r,r)
return new A.a3(A.a([v,A.aK(A.id(n.n(),o,p),0,0,0,20)],x.d),B.o,B.p,r,r)},
D1(){var w=Date.now(),v=this.c
if(B.f.c7(A.bi(0,G.aK_(v.b+" "+v.c).a-w,0).a,1e6)<=0)return!0
return!1}}
C.oV.prototype={
...
t=t.n()
r=G.aK_(l.b+" "+l.c)
k=A.J(""+A.b4(r)+"-"+n.e[A.bn(r)-1]+"-"+n.E0(A.cL(r))+"  "+n.E0(A.pU(r))+":"+n.E0(A.pV(r)))
k.ch=B.a_
k.d6$=B.i
k=A.a([t,k.n()],s)
...
o=A.J(A.d(l.y)+" Ton")
o.ch=B.a_
o=A.aK(new A.a3(A.a([new A.bG(k,B.ae,m,B.z,m),new A.bG(p,B.ae,m,B.z,m),new A.bG(A.a([t,o.n()],s),B.ae,m,B.z,m)],s),B.o,B.p,m,m),16,0,0,0)
t=A.J("Distance: ")
t.ch=D.dz
t=t.n()
p=A.J(A.d(F.aIU(l.at,1))+" kms")
p.ch=B.a_
p=A.a([t,p.n()],s)
t=A.b_("Driver Note:")
t.cx=D.dz
...
k=A.J(""+l.ch)
k.ch=B.a_
s=A.aK(new A.a3(A.a([new A.bG(w,B.ae,m,B.z,m),new A.bG(A.a([p,k.n()],s),B.ae,m,B.z,m)],s),B.o,B.p,m,m),16,0,0,0)
k=$.aA()
...
w.as=!1
w.at=!0},
E0(d){if(d>=10)return""+d
return"0"+d}}
var z=a.updateTypes(["oV(n0,n)","~()"])
C.awH.prototype={
...
t.d.$0()
w=2
return A.t(t.f.yC(t.e,t.c,new C.a5A(t)),$async$$0)
case 2:return A.z(null,v)}})
...
w(C.oV.prototype,"gXv","Xw",1)})();(function inheritance(){var w=a.inherit,v=a.inheritMany
w(C.p4,A.Q)
w(C.XK,A.U)
v(A.bP,[C.awH,C.awG])
w(C.awF,A.fH)
...
return{l:w("oV"),V:w("n0"),r:w("oY"),c:w("l<py>"),O:w("l<cC>"),x:w("l<a5>"),d:w("l<aC>"),s:w("l<j>"),S:w("l<e9>"),n:w("l<dH>"),A:w("l<dI>"),p:w("l<e>"),w:w("cQ"),P:w("aE"),D:w("mm"),N:w("j"),z:w("@"),H:w("~")}})();(function constants(){var w=a.makeConstList
...
D.Lf=new A.cP(B.de,20,B.S,null)
...
$__dart_deferred_initializers__["MHdrr0JohAJbd5NLI6ReR1eSUq8="] = $__dart_deferred_initializers__.current
